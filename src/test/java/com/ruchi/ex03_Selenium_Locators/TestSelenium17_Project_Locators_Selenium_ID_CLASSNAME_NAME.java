...
public class TestSelenium17_Project_Locators_Selenium_ID_CLASSNAME_NAME {
    ...
    public void test_vwo_login_invalid_login(){
        ...
        chromeOptions.addArguments("--start-maximized"); // This is another way to maximize window
        ...
        // Step 1 - Find the EMAIL ID and enter the admin@admin.com.
        // below HTML tag for VWO email input box is copied by inspecting element
        // <input open Tag
        // type="email"
